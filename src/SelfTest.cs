    ...
    internal static class SelfTest
    {
        ...
        private static void CheckTabStrip()
        {
            ...
            try
            {
                ...
                problems += ExpectHit(strip, Center(strip.NewTabButtonBounds()),
                    TabHitKind.NewTab, -1, "new tab button");
                ...
                // Between the "+" button and the window buttons: the island's own grab area
